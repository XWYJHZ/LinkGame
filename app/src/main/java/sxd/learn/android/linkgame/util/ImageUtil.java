package sxd.learn.android.linkgame.util;
...
import sxd.learn.android.linkgame.R;
import sxd.learn.android.linkgame.view.PieceImage;

/**
 * Created by Xiaodong on 4/16/2015.
 */
public class ImageUtil {
    ...
    /**
     * 从drawable目录中中获取size个图片资源ID(以p_为前缀的资源名称), 其中size为图片数量
     *
