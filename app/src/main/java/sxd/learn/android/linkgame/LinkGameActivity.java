package sxd.learn.android.linkgame;
...
import sxd.learn.android.linkgame.board.GameService;
import sxd.learn.android.linkgame.board.impl.GameServiceImpl;
import sxd.learn.android.linkgame.util.ImageUtil;
import sxd.learn.android.linkgame.view.GameView;
import sxd.learn.android.linkgame.Object.LinkInfo;
import sxd.learn.android.linkgame.view.Piece;


public class LinkGameActivity extends ActionBarActivity {
    // 游戏配置对象
    ...
    private void init()
    {
        config = new GameConf(8, 9, 2, 10 , 100, this);
        // 得到游戏区域对象
